...
import cn.dblearn.blog.core.common.util.HttpContextUtils;
import cn.dblearn.blog.core.common.util.IPUtils;
import cn.dblearn.blog.core.common.util.JsonUtils;
import cn.dblearn.blog.core.mapper.article.ArticleMapper;
import cn.dblearn.blog.core.mapper.book.BookMapper;
import cn.dblearn.blog.core.mapper.book.BookNoteMapper;
import cn.dblearn.blog.core.mapper.log.LogViewMapper;
...
public class LogViewAspect {
    ...
    private void saveViewLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        cn.dblearn.blog.core.entity.log.LogView viewLogEntity = new cn.dblearn.blog.core.entity.log.LogView();
