package cn.dblearn.blog.core.common.mq.aspect;
...
import cn.dblearn.blog.core.common.util.RabbitMqUtils;
...
public class RefreshEsMqAspect {
    ...
    @Pointcut("@annotation(cn.dblearn.blog.core.common.mq.annotation.RefreshEsMqSender)")
